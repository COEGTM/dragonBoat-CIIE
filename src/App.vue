      ...
      <div class="reportModal" v-show="report" @click="hideModal($event)">
        <div class="reportContain" ref="reportContain">
          ...
          <div
            ...
            :style="{
              backgroundImage:
                'url(' + require('../static/img/images/reportBg.png') + ')',
            }"
          >
            <div class="list-head">
      ...
      <div style="margin: 0 20px">
        <a-row>
          <a-col class="head">
            ...
            <a-button class="stopTrainBtn" @click="showCountDownModal()"
              >停止训练</a-button
            >
            <a-button
              class="stopTrainBtn"
              @click="showCountDownModal()"
              v-if="stopBtnTxt == '再次训练'"
              >再次训练</a-button
            >
            <a-button
              class="reportBtn"
              :disabled="stopBtnTxt !== '再次训练'"
              @click="ajaxUpdateRecord()"
              >查看报告</a-button
            >
          </a-col>
        </a-row>
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24" class="frontElbowWrapBox">
                  ...
                  <img
                    ...
                    v-show="
                      frontPosture.wrist.flag && frontPosture.wrist.flag == 2
                    "
                  />
                  <img
                    ...
                    v-show="
                      frontPosture.wrist.flag && frontPosture.wrist.flag == 1
                    "
                  />
                </a-col>
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      frontPosture.elbow.flag && frontPosture.elbow.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
                    src="./../static/img/images/orange.png"
                    v-show="
                      frontPosture.elbow.flag && frontPosture.elbow.flag == 1
                    "
                  />
                </a-col>
                <a-col :span="24" class="dec">
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      frontPosture.upperarm.flag &&
                      frontPosture.upperarm.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      frontPosture.torso.flag && frontPosture.torso.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
                    src="./../static/img/images/orange.png"
                    v-show="
                      frontPosture.torso.flag && frontPosture.torso.flag == 1
                    "
                  />
                </a-col>
                <a-col :span="24" class="dec">
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      frontPosture.knee.flag && frontPosture.knee.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
                    src="./../static/img/images/orange.png"
                    v-show="
                      frontPosture.knee.flag && frontPosture.knee.flag == 1
                    "
                  />
                </a-col>
                <a-col :span="24" class="dec">
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24" class="frontElbowWrapBox">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      backPosture.wrist.flag && backPosture.wrist.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
                    src="./../static/img/images/orange.png"
                    v-show="
                      backPosture.wrist.flag && backPosture.wrist.flag == 1
                    "
                  />
                </a-col>
                <a-col :span="24" class="dec">
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      backPosture.elbow.flag && backPosture.elbow.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
                    src="./../static/img/images/orange.png"
                    v-show="
                      backPosture.elbow.flag && backPosture.elbow.flag == 1
                    "
                  />
                </a-col>
                <a-col :span="24" class="dec">
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      backPosture.upperarm.flag &&
                      backPosture.upperarm.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
              ...
              <a-col :span="4" class="maskBox">
                <a-col :span="24">
                  ...
                  <img
                    ...
                    src="./../static/img/images/red.png"
                    v-show="
                      backPosture.torso.flag && backPosture.torso.flag == 2
                    "
                  />
                  <img
                    class="orangeMask mask"
                    src="./../static/img/images/orange.png"
                    v-show="
                      backPosture.torso.flag && backPosture.torso.flag == 1
                    "
                  />
                </a-col>
                <a-col :span="24" class="dec">
...
export default {
  ...
  mounted() {
    ...
    this.updateRecordForm.athlete_id =
      window.localStorage.getItem("athlete_id");
  ...
  methods: {
    ...
    ajaxGetPeriodicReportFront() {
      ...
      this.$axios
        .get(
          `${this.newIp}/rowing/report/${this.addRecordForm.athlete_id}/${this.record_id}/periodic/front_end`
        )
        .then((res) => {
    ...
    ajaxGetPeriodicReportBackend() {
      ...
      this.$axios
        .get(
          `${this.newIp}/rowing/report/${this.addRecordForm.athlete_id}/${this.record_id}/periodic/far_end`
        )
        .then((res) => {
          if (res.data && JSON.stringify(res.data) != "{}") {
    ...
    ajaxSummaryReport() {
      ...
      this.$axios
        .get(
          `${this.newIp}/rowing/report/${this.addRecordForm.athlete_id}/${this.record_id}/summary`
        )
        .then((res) => {
          if (res.data) {
    ...
    getathleteid(value) {
      ...
      this.updateRecordForm.athlete_id =
        window.localStorage.getItem("athlete_id");
      this.athleteInfo.athlete_name =
        window.localStorage.getItem("athlete_name");
      this.athleteInfo.sex = window.localStorage.getItem("sex");
    },
    handleBlur() {
      console.log("blur");
